...
def final_project_video() -> str:
    return """<section data-title="Final Project Explanation">
  <div class="inner">
    <div class="demo-tag tag-build">Final Project</div>
    <h2>Final Project &mdash; the 4.5 minute briefing</h2>
    <div class="subtitle">Watch the brief, then we'll walk the deliverables.</div>
    <div style="background:rgba(124,140,255,0.06); border:1px solid rgba(124,140,255,0.2); border-radius:14px; padding:32px; margin:24px auto; max-width:680px; text-align:center;">
      <div style="font-size:48px; margin-bottom:8px;">🎬</div>
      <div style="font-size:16px; font-weight:700; color:#fff; margin-bottom:6px;">Final Project Briefing &mdash; 4.5 min</div>
      <div style="font-size:13px; color:#8899bb;">In the live cohort, the instructor plays the briefing video here. Async-only? Read the <a href="../Final%20Project%20Brief.html" style="color:#60a5fa;">Final Project Brief</a> and the <a href="../juno-project-template/README.md" style="color:#60a5fa;">project template</a> — same content.</div>
    </div>
  </div>
</section>
"""
...
def deterministic_vs_probabilistic() -> str:
  ...
  <div class="inner">
    ...
    <div style="display:flex; gap:20px; margin:28px 0; align-items:stretch;">
      <div style="flex:1; background:rgba(100,116,139,0.08); border:1px solid rgba(100,116,139,0.2); border-radius:14px; padding:28px; text-align:left;">
        <div style="font-size:13px; font-weight:800; color:#94a3b8; text-transform:uppercase; letter-spacing:0.1em; margin-bottom:14px;">Deterministic Systems</div>
        <p style="font-size:14px; color:#cdd5e3; margin-bottom:16px; line-height:1.55;">Most software you've managed. The code follows rigid pre-written instructions where the same input always produces the exact same output.</p>
        <div style="background:rgba(0,0,0,0.25); border-radius:10px; padding:16px; font-family:'IBM Plex Mono', monospace; font-size:13px; color:#cdd5e3;">
          <div style="color:#94a3b8;">User Input &nbsp;→&nbsp; Code &nbsp;→&nbsp; <span style="color:#6ee7b7;">Predictable Output</span></div>
        </div>
        <p style="font-size:12px; color:#8899bb; margin-top:14px;"><strong>E.g.</strong> keyword search, login auth, Excel formulas.</p>
      </div>
      <div style="display:flex; align-items:center; justify-content:center;">
        <div style="background:rgba(255,255,255,0.06); border:2px solid rgba(255,255,255,0.12); border-radius:50%; width:60px; height:60px; display:flex; align-items:center; justify-content:center; font-family:'Poppins',sans-serif; font-weight:900; font-size:18px; color:#fff;">VS</div>
      </div>
      <div style="flex:1; background:rgba(96,165,250,0.08); border:1px solid rgba(96,165,250,0.25); border-radius:14px; padding:28px; text-align:left;">
        <div style="font-size:13px; font-weight:800; color:#60a5fa; text-transform:uppercase; letter-spacing:0.1em; margin-bottom:14px;">Probabilistic Systems</div>
        <p style="font-size:14px; color:#cdd5e3; margin-bottom:16px; line-height:1.55;">AI-powered products. The model predicts the most likely next step, where the same input can produce different valid outputs each time.</p>
        <div style="background:rgba(0,0,0,0.25); border-radius:10px; padding:16px; font-family:'IBM Plex Mono', monospace; font-size:13px; color:#cdd5e3;">
          <div style="color:#94a3b8;">User Input &nbsp;→&nbsp; Code &nbsp;→&nbsp; <span style="color:#79c0ff;">Multiple potential outputs</span></div>
        </div>
        <p style="font-size:12px; color:#8899bb; margin-top:14px;"><strong>E.g.</strong> semantic (RAG) search, LLM summarisation, image generation.</p>
      </div>
    </div>
    <p style="font-size:14px; color:#8899bb; text-align:center;">You can no longer write &ldquo;the output will be X.&rdquo; You define the <em>qualities and guardrails</em> of an acceptable output.</p>
  </div>
</section>
"""
...
def dual_role() -> str:
  ...
  <div class="inner">
    ...
    <h2>Navigating Uncertainty: The PM&rsquo;s Dual Role</h2>
    <div class="subtitle">Same job. Two operating contexts. Different skills.</div>
    <div style="display:flex; gap:20px; margin:24px 0;">
      <div style="flex:1; background:rgba(96,165,250,0.06); border:1px solid rgba(96,165,250,0.25); border-radius:14px; padding:28px; text-align:left;">
        <div style="display:flex; align-items:center; gap:12px; margin-bottom:14px;">
          <div style="font-size:32px;">🏗️</div>
          <div style="font-size:14px; font-weight:800; color:#60a5fa; text-transform:uppercase; letter-spacing:0.08em;">When Building AI Products</div>
        </div>
        <p style="font-size:15px; color:#cdd5e3; line-height:1.6;">When scoping requirements for stakeholders and engineering, you can&rsquo;t define a single exact output &mdash; the system is designed to change.</p>
        <p style="font-size:14px; color:#8899bb; line-height:1.55; margin-top:12px;">Your PRD must evolve to specify <strong>qualities and guardrails</strong> of an acceptable response &mdash; ensuring the team builds a safe, reliable AI experience. You're a city planner, not a building architect.</p>
      </div>
      <div style="flex:1; background:rgba(52,211,153,0.06); border:1px solid rgba(52,211,153,0.25); border-radius:14px; padding:28px; text-align:left;">
        <div style="display:flex; align-items:center; gap:12px; margin-bottom:14px;">
          <div style="font-size:32px;">⚡</div>
          <div style="font-size:14px; font-weight:800; color:#34d399; text-transform:uppercase; letter-spacing:0.08em;">When Using AI in Workflows</div>
        </div>
        <p style="font-size:15px; color:#cdd5e3; line-height:1.6;">The AI&rsquo;s variability can be a source of creativity &mdash; but it means you are responsible for critically evaluating each unique output.</p>
        <p style="font-size:14px; color:#8899bb; line-height:1.55; margin-top:12px;">You guide the AI toward the desired result through <strong>prompt iteration</strong> and your strategic judgment. The interaction is a conversation, not a command.</p>
      </div>
    </div>
  </div>
</section>
