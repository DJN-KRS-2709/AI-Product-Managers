...
<ol style="text-align:left; max-width:760px; margin:18px auto;">
  <li><strong>Step 1.</strong> Open <a href="https://lovable.dev" target="_blank" rel="noopener" style="color:#60a5fa;">Lovable</a>. In the prompt builder, pick <strong>Option A &middot; Build Your Own</strong> (pre-filled, edit to taste) or <strong>Option B &middot; Juno Baseline</strong> (one-click, free-tier-friendly). Click <em>Copy for Lovable</em> and paste into the Lovable chat.</li>
  <li><strong>Step 2.</strong> Refine the design with a follow-up prompt. The tool gives you two paths ready to copy: <strong>Brand alignment</strong> (upload a screenshot of your company&rsquo;s UI) or <strong>Vibe match</strong> (mimic Linear, Notion, etc. &mdash; editable).</li>
  <li><strong>Step 3.</strong> Test it. Copy the <strong>Sarah / Data Analyst</strong> transcript from the tool, paste it into the <em>Raw User Transcripts</em> column, and press <strong>Process</strong>. Note where the prototype falls short &mdash; you&rsquo;ll debrief that on the next slide.</li>
</ol>
<p style="font-size:13px; color:#8899bb; max-width:760px; margin:18px auto 0;"><strong>Credit-saver.</strong> Lovable free accounts are capped at 2&ndash;3 prompts/day. Use the tool&rsquo;s <em>Refine in LLM first</em> tab to polish your prompt in ChatGPT/Claude before paying Lovable credits. Or swap Lovable for <a href="https://stitch.withgoogle.com/" target="_blank" rel="noopener" style="color:#60a5fa;">Google Stitch</a> or <a href="https://bolt.new" target="_blank" rel="noopener" style="color:#60a5fa;">Bolt</a>.</p>
"""
