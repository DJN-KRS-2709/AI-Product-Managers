  ...
  <div class="inner">
    ...
    <div style="max-width:1100px; margin:14px auto 0;">
      <svg viewBox="0 0 1100 540" preserveAspectRatio="xMidYMid meet" style="width:100%; height:auto; display:block;">
        ...
        <!-- UP RETURN (mint, dashed). Each arrow takes the SHORTEST clean
             orthogonal route to its target. None of them cross another tile,
             and none of them cross each other.
               1) AI-gen answer  -> Link to policy (primary, around the left).
               2) AI-gen answer  -> Create a support ticket (fallback, dimmer
                  + shorter dashes - direct lift through the corridor between
                  the iceberg's left edge and the surface tiles).
               3) AI-gen confirmation -> Link to new request on Workday (right
                  side, lifts straight through the gap above Workday API and
                  AI-driven update). -->
        <path d="M 380 488 L 380 470 L 190 470 L 190 130 L 400 130 L 400 104" stroke="#34d399" stroke-width="1.5" fill="none" stroke-dasharray="6,4" marker-end="url(#arr-mint)"/>
        <path d="M 340 488 L 340 478 L 270 478 L 270 104" stroke="#34d399" stroke-width="1.5" fill="none" stroke-dasharray="3,3" opacity="0.75" marker-end="url(#arr-mint)"/>
        <path d="M 820 488 L 820 350 L 900 350 L 900 104" stroke="#34d399" stroke-width="1.5" fill="none" stroke-dasharray="6,4" marker-end="url(#arr-mint)"/>
    ...
    <div style="display:grid; grid-template-columns:1fr 1fr 1fr; gap:8px; max-width:1080px; margin:10px auto 0;">
      ...
      <div style="background:rgba(52,211,153,0.08); border:1px solid rgba(52,211,153,0.30); border-radius:8px; padding:7px 11px; text-align:left;">
        ...
        <div style="font-size:11px; color:#cdd5e3; line-height:1.45; margin-top:1px;">Generated output returns to the user. Fallback (dim) routes to the support-ticket failsafe.</div>
      </div>
    </div>
  </div>
</section>
