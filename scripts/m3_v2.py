...
def rag_in_practice_diagram() -> str:
    ...
    Layout: the Vector DB is treated as a shared central artifact, with the
    offline pipeline pouring vectors INTO it from above, and the online
    pipeline reading FROM it from the side. This matches the original
    PowerPoint where Vector DB is the visual hub of both flows.
    """
  ...
  <div class="inner">
    ...
    <div class="subtitle">Two pipelines &mdash; one shared <strong style="color:#fff;">Vector DB</strong>. Offline fills it. Online queries it.</div>

    <!-- OFFLINE PIPELINE - flows left-to-right ending at D -->
    <div style="max-width:1040px; margin:18px auto 0; background:rgba(255,255,255,0.025); border:1px solid rgba(255,255,255,0.08); border-radius:14px; padding:12px 18px;">
      <div style="font-family:'Poppins',sans-serif; font-size:10.5px; font-weight:900; color:#bcb1ff; letter-spacing:0.14em; text-transform:uppercase; margin-bottom:8px;">&#x1F4E6; Step 0 &middot; Data Preparation (offline &middot; runs on schedule)</div>
      <div style="display:grid; grid-template-columns:1fr auto 1fr auto 1fr auto 1fr; gap:8px; align-items:stretch;">
        ...
        <div style="display:flex; align-items:center; justify-content:center; font-family:'Poppins',sans-serif; font-size:18px; color:#475569;">&rarr;</div>
        <div style="background:rgba(124,140,255,0.10); border:1px solid rgba(124,140,255,0.4); border-radius:10px; padding:8px 10px; text-align:center;">
    ...
    <!-- D HANDOFF - clean centered downward arrow -->
    <div style="display:flex; flex-direction:column; align-items:center; gap:0; margin:6px auto 0;">
      <div style="width:2px; height:14px; background:linear-gradient(180deg, transparent, #bcb1ff);"></div>
      <div style="background:rgba(124,140,255,0.18); border:1px solid rgba(124,140,255,0.5); color:#fff; font-family:'Poppins',sans-serif; font-size:10.5px; font-weight:900; letter-spacing:0.14em; padding:5px 14px; border-radius:99px;">D &nbsp;&middot;&nbsp; embedded chunks loaded &rarr;</div>
      <div style="width:0; height:0; border-left:7px solid transparent; border-right:7px solid transparent; border-top:9px solid #bcb1ff;"></div>
    </div>

    <!-- CENTRAL HUB - Vector DB shared between offline and online -->
    <div style="max-width:340px; margin:0 auto; background:linear-gradient(180deg, rgba(124,140,255,0.16), rgba(124,140,255,0.08)); border:2px solid rgba(124,140,255,0.65); border-radius:14px; padding:14px 18px; text-align:center; box-shadow:0 0 0 6px rgba(124,140,255,0.08), 0 8px 30px rgba(124,140,255,0.18);">
      <div style="font-size:28px; line-height:1; margin-bottom:4px;">&#x1F5C4;&#xFE0F;</div>
      <div style="font-family:'Poppins',sans-serif; font-size:16px; font-weight:800; color:#fff; letter-spacing:0.02em;">Vector Database</div>
      <div style="font-size:11px; color:#cdd5e3; margin-top:4px; line-height:1.45;">Populated by <strong style="color:#bcb1ff;">D</strong> &middot; Queried at step <strong style="color:#bcb1ff;">2</strong></div>
    </div>

    <!-- 2. RETRIEVE arrow upward (from online flow up to Vector DB) -->
    <div style="display:flex; flex-direction:column; align-items:center; gap:0; margin:0 auto;">
      <div style="width:0; height:0; border-left:7px solid transparent; border-right:7px solid transparent; border-bottom:9px solid #79c0ff; margin-top:6px;"></div>
      <div style="background:rgba(96,165,250,0.18); border:1px solid rgba(96,165,250,0.5); color:#fff; font-family:'Poppins',sans-serif; font-size:10.5px; font-weight:900; letter-spacing:0.14em; padding:5px 14px; border-radius:99px;">2 &nbsp;&middot;&nbsp; similarity search &uarr;</div>
      <div style="width:2px; height:14px; background:linear-gradient(0deg, transparent, #79c0ff);"></div>
    </div>

    <!-- ONLINE FLOW - Query, then up to VDB, then continues -->
    <div style="max-width:1040px; margin:0 auto; background:rgba(96,165,250,0.05); border:1px solid rgba(96,165,250,0.25); border-radius:14px; padding:12px 18px;">
      ...
      <div style="display:grid; grid-template-columns:auto 1fr auto 1fr auto 1fr auto 1fr auto; gap:6px; align-items:stretch;">
        <div style="display:flex; align-items:center; justify-content:center; font-family:'Poppins',sans-serif; font-size:11px; color:#a0aec0; font-weight:900; letter-spacing:0.1em;">User</div>
        <div style="background:rgba(59,130,246,0.15); border:1px solid rgba(59,130,246,0.5); border-radius:10px; padding:8px 10px; text-align:center;">
          <div style="font-family:'Poppins',sans-serif; font-size:10px; font-weight:900; color:#60a5fa; letter-spacing:0.1em; margin-bottom:3px;">1</div>
          <div style="font-size:12px; color:#fff; font-weight:700;">Query</div>
          <div style="font-size:10px; color:#8899bb; margin-top:2px;">Embed the question</div>
        </div>
        <div style="display:flex; align-items:center; justify-content:center; font-family:'Poppins',sans-serif; font-size:18px; color:#475569;">&rarr;</div>
        <div style="background:rgba(96,165,250,0.10); border:1px dashed rgba(124,140,255,0.55); border-radius:10px; padding:8px 10px; text-align:center;">
          <div style="font-family:'Poppins',sans-serif; font-size:10px; font-weight:900; color:#bcb1ff; letter-spacing:0.1em; margin-bottom:3px;">2</div>
          <div style="font-size:12px; color:#fff; font-weight:700;">Search the Vector DB &uarr;</div>
          <div style="font-size:10px; color:#8899bb; margin-top:2px;">Returns top-K matches</div>
        </div>
        <div style="display:flex; align-items:center; justify-content:center; font-family:'Poppins',sans-serif; font-size:18px; color:#475569;">&rarr;</div>
        <div style="background:rgba(217,142,34,0.15); border:1px solid rgba(217,142,34,0.5); border-radius:10px; padding:8px 10px; text-align:center;">
          <div style="font-family:'Poppins',sans-serif; font-size:10px; font-weight:900; color:#fbbf24; letter-spacing:0.1em; margin-bottom:3px;">3 &middot; 4</div>
          <div style="font-size:12px; color:#fff; font-weight:700;">Augment prompt</div>
          <div style="font-size:10px; color:#8899bb; margin-top:2px;">Stitch chunks + query</div>
        </div>
        <div style="display:flex; align-items:center; justify-content:center; font-family:'Poppins',sans-serif; font-size:18px; color:#475569;">&rarr;</div>
        <div style="background:rgba(52,211,153,0.15); border:1px solid rgba(52,211,153,0.5); border-radius:10px; padding:8px 10px; text-align:center;">
          <div style="font-family:'Poppins',sans-serif; font-size:10px; font-weight:900; color:#34d399; letter-spacing:0.1em; margin-bottom:3px;">5</div>
          <div style="font-size:12px; color:#fff; font-weight:700;">LLM &rarr; Response</div>
          <div style="font-size:10px; color:#8899bb; margin-top:2px;">Grounded answer</div>
        </div>
        <div style="display:flex; align-items:center; justify-content:center; font-family:'Poppins',sans-serif; font-size:11px; color:#a0aec0; font-weight:900; letter-spacing:0.1em;">User</div>
      </div>
    </div>
